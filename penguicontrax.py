...
def login():
    ...
    if provider == 'google':
        ...
        return facebook.authorize(callback=penguicontrax_constants.PUBLIC_URL + 'oauth-authorized-facebook')
    elif provider == 'twitter':
        return twitter.authorize(callback=penguicontrax_constants.PUBLIC_URL + 'oauth-authorized-twitter')
    return redirect(oid.get_next_url())
